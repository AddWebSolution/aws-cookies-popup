    ...
    <form action="" method="post" id="<?php echo $namespace; ?>-form">
        <div id="content">
            ...
            <div class="highlight secondary">
                ...
                <p class="aws-color-picker-parent"><b><?php print("Close Button Back-ground Color");?></b><br /><input type="text" name="data[closecolor]" value="<?php echo ($this->get_option( 'closecolor' ) ); ?>" class="aws-color-field" data-default-color="<?php echo ($this->get_option( 'closecolor' ) ); ?>"><div style="position: absolute;" id="aws-color-picker"></div><b><?php print("Close Button Text");?></b><br /><input type="text" name="data[closetext]" value="<?php echo ($this->get_option( 'closetext' ) ); ?>"></p>
